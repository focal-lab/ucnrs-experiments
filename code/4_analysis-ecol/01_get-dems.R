...
hast20_bbox = st_bbox(hast20) |> st_as_sfc() |> st_buffer(500) |> st_as_sf() |> st_transform(4326)
borr20_bbox = st_bbox(borr20) |> st_as_sfc() |> st_buffer(500) |> st_as_sf() |> st_transform(4326)
